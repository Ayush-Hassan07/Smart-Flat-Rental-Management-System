...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($con, "INSERT INTO flats (landlord_id, flat_name, description, location, room_picture, rent, bedrooms, bathrooms, square_feet, amenities, contact_email, contact_phone, additional_images) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, 'issssdiiissss', $_SESSION['user_id'], $flat_name, $description, $location, $room_picture, $rent, $bedrooms, $bathrooms, $square_feet, $amenities_json, $contact_email, $contact_phone, $additional_images_json);
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="rent" class="form-control" 
                               value="<?= isset($flat) ? htmlspecialchars($flat['rent']) : '' ?>" required>
                    </div>
                    <div class="col-md-4 mb-3">
